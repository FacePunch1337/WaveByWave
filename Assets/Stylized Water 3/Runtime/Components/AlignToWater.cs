...
#pragma warning restore 108,114
        ...
        [NonSerialized] public bool externalMotionControl;
        public bool HasExternalMotionTarget { get; private set; }
        public Vector3 ExternalMotionTargetPosition { get; private set; }
        public Quaternion ExternalMotionTargetRotation { get; private set; } = Quaternion.identity;
        ...
        private void OnEnable()
        {
            ...
            {
                // Guard against duplicate callbacks after script reloads or prefab regeneration.
                UnityEditor.SceneView.duringSceneGui -= DuringSceneViewUpdate;
                UnityEditor.SceneView.duringSceneGui += DuringSceneViewUpdate;
            }
#endif
        ...
        {
#if UNITY_EDITOR
            // OnDisable may run while Unity still reports Application.isPlaying=true when
            // leaving Play Mode. Always unsubscribe so SceneView never retains a destroyed object.
            UnityEditor.SceneView.duringSceneGui -= DuringSceneViewUpdate;
#endif
        ...
        private void ApplyTransform()
        {
            ...
            ExternalMotionTargetPosition = position;
            ExternalMotionTargetRotation = newRotation;
            HasExternalMotionTarget = true;
            if (Application.isPlaying && rigidbody)
            {
                // A character/mover system may need to apply this calculated pose in its own
                // ordered physics pass so platforms and characters share exactly one timeline.
